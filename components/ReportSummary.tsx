...
export function ReportSummary({ rows }: { rows: MonthlyReportRow[] }) {
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full min-w-[560px] text-lg">
        <thead>
          <tr className="border-b border-slate-200 text-left text-base font-semibold uppercase tracking-wide text-slate-500 dark:border-navy-800 dark:text-slate-400">
            <th className="px-5 py-5">Month</th>
            <th className="px-5 py-5 text-right">Income</th>
            <th className="px-5 py-5 text-right">Expenses</th>
        ...
        <tbody className="divide-y divide-slate-100 dark:divide-navy-800">
          {rows.map((r) => (
            ...
            >
              <td className="px-5 py-5 font-medium text-navy-900 dark:text-white">
                {r.month}
              </td>
              <td className="px-5 py-5 text-right font-mono text-emerald-600 dark:text-emerald-400">
                {formatCurrency(r.income)}
              </td>
              <td className="px-5 py-5 text-right font-mono text-slate-600 dark:text-slate-300">
        ...
        <tfoot>
          <tr className="border-t-2 border-slate-200 font-semibold dark:border-navy-700">
            <td className="px-5 py-5 text-navy-900 dark:text-white">Total</td>
            <td className="px-5 py-5 text-right font-mono text-emerald-600 dark:text-emerald-400">
            ...
            <td className="px-5 py-5 text-right font-mono text-navy-900 dark:text-white">
